...
import { Play, Clock, Trophy, CheckCircle, XCircle } from 'lucide-react';
...
export function ChallengeSolving() {
  ...
  const runTests = async () => {
    ...
    try {
      // Simulate test execution (in a real app, this would be sent to a code execution service)
  ...
  const submitSolution = async () => {
    ...
    try {
      ...
      const score = allTestsPassed ? challenge.points : 0;
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">This challenge could not be loaded.</p>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">{challenge.category?.name}</p>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="bg-gradient-to-r from-green-600 to-emerald-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:from-green-700 hover:to-emerald-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Submit Solution
              </button>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              {challenge.constraints && (
                <div className="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                  ...
                  <p className="text-sm text-yellow-700 whitespace-pre-wrap">{challenge.constraints}</p>
                </div>
              )}
            </div>
